...
<head>
    <meta charset="utf-8">
    <title>Bank Transfer Report | Apex Payroll</title>
    <!-- Favicons -->
        ...
        <div class="main_container">
            ...
            <div class="" style="width: 100%; margin: 1%;" role="main">
                                ...
                                <table width="130%">
                                    <tr>
                                        <form action="#" method="get">
                                            <td>
                                                <h3>Bank Transfer Reporting<br /> <small>Genarate Bank Transfer
                                                        Report</small></h3>
                                            </td>
                                            <td width="100">&nbsp;</td>
                                            <td width="50">
              ...
              ?>
                    ...
                    $resalx = Search("select u.uid,u.fname as emp,u.bankno,u.bank from user u,salarycomplete sal where u.uid = sal.uid and u.bankno != '' and u.bank != '' and u.isactive like '" . $_GET["emp_status"] . "' group by sal.uid order by cast(u.epfno as unsigned) ASC");
