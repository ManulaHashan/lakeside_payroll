...
<head>
    <meta charset="utf-8">
    <title>Cash Payment Reports | Apex Payroll</title>
    <!-- Favicons -->
        ...
        <div class="main_container">
            ...
            <div class="" style="width: 100%; margin: 1%;" role="main">
                                ...
                                <table width="130%">
                                    <tr>
                                        <form action="#" method="get">
                                            <td>
                                                <h3>Cash Payment Reporting<br /> <small>Genarate Cash Payment
                                                        Reports</small></h3>
                                            </td>
                                            <td width="100">&nbsp;</td>
                                            <td width="50">
              ...
              ?>
                    ...
                    $resalx = Search("select u.uid,u.fname as emp,u.bankno,u.bank,u.epfno from user u,salarycomplete sal where u.uid = sal.uid and u.bankno = '' and u.bank = '' and u.isactive like '" . $_GET["emp_status"] . "' group by sal.uid order by cast(u.epfno as unsigned) ASC");
                    ...
                    while ($resultalx = mysqli_fetch_assoc($resalx)) {
                      ...
                      $resalxr = Search("select a.paid from salarycomplete a, user b where a.uid = '" . $resultalx["uid"] . "' and a.uid = b.uid and a.month = '" . $_GET["month"] . "' and a.year = '" . $_GET["year"] . "'");
                      ...
                      if ($resultalxr = mysqli_fetch_assoc($resalxr)) {
                        ...
                        echo "<td style='text-align: right'>" . number_format($Empaid, 2) . "</td>";
                      } else {
                    ...
                    echo "<td style='text-align: right'>" . number_format($epaid, 2) . "</td>";
                    echo "</tr>";
                    ?>
