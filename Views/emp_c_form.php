...
<head>
    <meta charset="utf-8">
    <title>C Form | Apex Payroll</title>
    <!-- Favicons -->
            ...
            <div class="" style="width: 100%; margin: 1%;" role="main">
                                ...
                                <table width="120%">
                                    <tr>
                                        <form action="#" method="get">
                                            <td>
                                                <h3>C Form<br /> <small>Genarate C Form</small></h3>
                                            </td>
                                            <td width="100">&nbsp;</td>
                                            <td width="50">
                                                Month :
              ...
              ?>
                            ...
                            <div id="tdatax" style="width:90%;">
                                <table border="1" class="table table-bordered" style="border-collapse: collapse;">
                                    <thead>
                                        ...
                                        <tr>
                                            <th colspan="3"></th>
                                            <th colspan="2" style="text-align: center">Contribution Rs.</th>
                                            <th></th>
                                        </tr>
                                        <tr>
                ...
                <th>Occupation Classification Grade</th>
                    ...
                    $resalx = Search("select uid,fname as emp,nic,epfno from user where isactive='1'");
                    while ($resultalx = mysqli_fetch_assoc($resalx)) {
                      ...
                      if ($resultalxr = mysqli_fetch_assoc($resalxr)) {
                        ...
                        echo "<td style='text-align: right'>" . number_format($Totemp, 2) . "</td>";
                      } else {
                    ...
                    echo "<td style='text-align: right'>" . number_format($tot_earn, 2) . "</td>";
                    echo "</tr>";
                    ?>
