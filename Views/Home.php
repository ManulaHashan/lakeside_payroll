...
<head>
    ...
    <link rel="stylesheet"
        href="../New_Dashboard_Data/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    function getBdayDetails() {
        ...
        $.ajax({
            type: 'POST',
            url: "../Controller/dashboard.php?request=bdaydetails&Month_data=" + Month_data + "&dept_data=" +
                dept,
            success: function(data) {
    ...
    function monthAttChartDATA() {
        ...
        var url = "../Controller/dashboard.php?request=dailyLateCount&Year_data=" + Year_data + "&Month_data=" +
            Month_data + "&dept=" + dept;
            ...
            success: function(data) {
                ...
                var areaChartData = {
                    ...
                    datasets: [{
                            ...
                            data: [arrM[0], arrM[1], arrM[2], arrM[3], arrM[4], arrM[5], arrM[6],
                                arrM[7], arrM[8], arrM[9], arrM[10], arrM[11], arrM[12], arrM[
                                    13], arrM[14], arrM[15], arrM[16], arrM[17], arrM[18], arrM[
                                    19], arrM[20], arrM[21], arrM[22], arrM[23], arrM[24], arrM[
                                    25], arrM[26], arrM[27], arrM[28], arrM[29], arrM[30]
                            ]
                        },
                        {
                            label: 'Female',
                            ...
                            data: [arrF[0], arrF[1], arrF[2], arrF[3], arrF[4], arrF[5], arrF[6],
                                arrF[7], arrF[8], arrF[9], arrF[10], arrF[11], arrF[12], arrF[
                                    13], arrF[14], arrF[15], arrF[16], arrF[17], arrF[18], arrF[
                                    19], arrF[20], arrF[21], arrF[22], arrF[23], arrF[24], arrF[
                                    25], arrF[26], arrF[27], arrF[28], arrF[29], arrF[30]
                            ]
                        },
                    ]
                }
    ...
    function dailyAbsentChartDATA() {
        ...
        var url = "../Controller/dashboard.php?request=dailyAbsentCount&Year_data=" + Year_data + "&Month_data=" +
            Month_data + "&dept=" + dept;
        ...
        <div class="wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    ?>
                                        <option value="<?php echo $result["did"]; ?>"> <?php echo $result["name"]; ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>&nbsp;&nbsp;
                                ...
                                <div class="form-group">
                                    <br>
                                    <a class="btn bg-secondary" style="height: 44px;"
                                        onclick="CountUsers();monthAttChart();monthAttChartDATA();dailyAbsentChartDATA();getBdayDetails();">
                                        <center>
