            ...
            <td width="50px">
                ...
                <div class="titlebarNaviBtn">
                    ...
                    <div id="naviPanel">
                        ...
                        <div id="oppanel_button" class="oppanel_Title"><a href="../Views/Home.php" style="color:white;"><img src="../Images/dashboard.png" width="35px" >&nbsp Dashboard</a></div>
                        ...
                        <?php if (in_array("Employee Management (Main Privilege)", $privs)) { ?>
                            ...
                            <div id="panelitem2" style="background-color: #CCC8C8;"> 
                                <blockquote style="border: none; background-color: #CCC8C8; padding-top: 0px; padding-left: 10px; margin:0;">
                                   ...
                                   <?php if (in_array("Approve Details Change Request (Sub Privilege)", $privs)) { ?>
                                   <a class="link" href="../Views/approve_change_req.php">* Approve Details Change Request </a>
                                   <?php } ?>
                            ...
                            <div id="panelitem3" style="background-color: #CCC8C8;"> 
                                <blockquote style="border: none; background-color: #CCC8C8; padding-top: 0px; padding-left: 10px; margin:0;">
                                   ...
                                   <?php } ?>
                                    ...
                                    <a class="link" href="../Views/month_wise_absent_report.php">* Month Wise Absent Report</a>
                                    <?php } ?>
