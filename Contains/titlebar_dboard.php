<div class="titlebarDiv"
    style="width:100%; background: linear-gradient(90deg, rgba(204,204,204,1) 0%, rgba(54,125,148,1) 54%, rgba(31,32,32,1) 74%);">
    <table width="100%"
        style="font-size: 18px; font-family: Constantia, 'Lucida Bright', 'DejaVu Serif', 'Georgia', 'serif';">
        <tr valign="middle">
            <td width="1px;" class="" style="height: 60px;"><img src="../Images/letter/7.png"
                    style="width:50px;margin-top:5px;cursor: pointer;" onclick="window.location.href = 'Home.php'"></td>
            <td width="">
            ...
            <td width="5px">
                <form action="../Controller/logout.php">
                    <input type="submit"
                        style="background-image: url(../Images/logout.png);background-size:100% 100%;background-color: transparent;background-repeat: no-repeat;background-position: 0px 0px;border: none;cursor: pointer;height: 40px;width:30px;vertical-align: middle;"
                        name="logout" value="" />
                </form>
            </td>
            <td></td>
            <td width="50px">
                ...
                <div class="titlebarNaviBtn">
                    ...
                    <div id="naviPanel">
                        ...
                        <div id="oppanel_button" class="oppanel_Title"><a href="../Views/Home.php"
                                style="color:white;"><img src="../Images/dashboard.png" width="35px">&nbsp Dashboard</a>
                        </div>
                        <div id="panelitem" style="background-color: #CCC8C8;"></div>

                        <?php if (in_array("Employee Management (Main Privilege)", $privs)) { ?>

                        <div id="oppanel_button" class="oppanel_Title"
                            onClick="naviDrop('panelitem2', '200px'); LeaveCount();"><img src="../Images/employee.png"
                                width="35px">&nbsp Employee Management</div>

                        <div id="panelitem2" style="background-color: #CCC8C8;">
                            <blockquote
                                style="border: none; background-color: #CCC8C8; padding-top: 0px; padding-left: 10px; margin:0;">
                                <br>
                        ...
                        <div id="oppanel_button" class="oppanel_Title"
                            onClick="naviDrop('panelitem3', '420px'); LeaveCount();"><img src="../Images/attendance.png"
                                width="35px">&nbsp Attendance & Leave</div>
                        ...
                        <div id="oppanel_button" class="oppanel_Title"
                            onClick="naviDrop('panelitem4', '480px'); LeaveCount();"><img src="../Images/salary.png"
                                width="35px">&nbsp Payroll Management</div>
                        ...
                        <div id="panelitem4" style="background-color: #CCC8C8;">
                            <blockquote
                                ...
                                <?php } ?>
                                <?php if (in_array("OPD and IPD Claim Bills (Sub Privilege)", $privs)) { ?>
                                <small style="font-weight: bold; color: gray;"><u>Manage OPD & IPD Claim
                                        Bills</u></small>
                                <a class="link" href="../Views/emp_opd_ipd_claim.php">* OPD & IPD Claim</a>
                                <?php } ?>
                        ...
                        <div id="oppanel_button" class="oppanel_Title" onClick="naviDrop('panelitem5', '100px')"><img
                                src="../Images/settings.png" width="35px">&nbsp System Settings</div>
