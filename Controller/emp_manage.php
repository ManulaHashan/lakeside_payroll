...
if (isset($_REQUEST["request"])) {
    ...
    echo $out;
        ...
        while ($result = mysqli_fetch_assoc($res)) {
            ...
            $out.="<tr style='cursor: pointer;' id='".$details."' onclick='select_branch(id)'><td>".$result["pid"]."</td><td>".$descrip."</td><td><img src='../Icons/remove.png' onclick='deleteBranch(" . $result["pid"] . ")'></td></tr>";
        }
        $out.="</table>";
        echo $out;
    }
