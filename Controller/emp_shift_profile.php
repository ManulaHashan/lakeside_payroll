  ...
  if ($_REQUEST["request"] == "getSettings") {
    ...
    if ($resultss = mysqli_fetch_assoc($res)) {
      ...
      if (empty($_REQUEST["intime"]) && empty($_REQUEST["outtime"]) && empty($_REQUEST["wrkLate"]) && empty($_REQUEST["halfMLate"]) && empty($_REQUEST["halfELate"]) && empty($_REQUEST["shrtMLate"]) && empty($_REQUEST["shrtELate"])) {
        $querySettings = "insert into shift_working_time_profile_settings(name, sh_intime, sh_outtime, sh_half_slot_morning, sh_half_slot_evening, sh_short_morning, sh_short_evening, sh_working_late, sh_half_m_late, sh_half_e_late, sh_short_m_late, sh_short_e_late, clr_code) values('" . $_REQUEST["wrkname"] . "',NULL,NULL,'" . $half_Morning . "','" . $half_Evening . "','" . $Short_Morning . "','" . $Short_Evening . "',NULL,NULL,NULL,NULL,NULL,'" . $_REQUEST["clrcode"] . "')";
      } else {
        $querySettings = "insert into shift_working_time_profile_settings(name, sh_intime, sh_outtime, sh_half_slot_morning, sh_half_slot_evening, sh_short_morning, sh_short_evening, sh_working_late, sh_half_m_late, sh_half_e_late, sh_short_m_late, sh_short_e_late, clr_code) values('" . $_REQUEST["wrkname"] . "','" . $_REQUEST["intime"] . "','" . $_REQUEST["outtime"] . "','" . $half_Morning . "','" . $half_Evening . "','" . $Short_Morning . "','" . $Short_Evening . "','" . $_REQUEST["wrkLate"] . "','" . $_REQUEST["halfMLate"] . "','" . $_REQUEST["halfELate"] . "','" . $_REQUEST["shrtMLate"] . "','" . $_REQUEST["shrtELate"] . "','" . $_REQUEST["clrcode"] . "')";
      }
