<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="../home.php">
            <div class="logo-img">
               <img src="../lakeside_circle.png" class="header-brand-img" style="width: 36px;" alt="lavalite"> 
            </div>
            <span class="text" style="font-size: 17px;">&nbsp;Lakeside Employees</span>
        </a>
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        ...
                        <a href="../Views/emp_sal_summery.php" class="menu-item"><i class="ik ik-dollar-sign"></i>Salary Summery</a>
                    </div>
                </div>
            </nav>
        </div>
