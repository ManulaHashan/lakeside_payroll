...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadTable() {
            ...
            var url = "../Controller/emp_leave_req.php?request=getleave&frmdate=" + $('#fdate').val() + "&tod=" + $(
                '#tdate').val() + "&decission=" + $("#lvdes").val();
            ...
            if ($('#datefrom').val() != "" && $('#days').val() != "") {
                if ($('#datefrom').val() >= $('#pdate').val()) {
                    ...
                    if (confirmAction) {
                        ...
                        var url = "../Controller/emp_leave_req.php?request=leaverequest&leavetype=" + $('#ltype').val() +
                            "&from=" + $('#datefrom').val() + "&day=" + $('#days').val();
                    ...
                    if (Part == "A") {
                        if (Leave_COUNT == "0") {
                            ...
                            if (x == -1) {
                                ...
                                tr += "<td><center><img src='../img/reject.png' onclick='removeItem(" + lid + "," + lnom +
                                    "," + Leave_No + "" + ldate.replace(/[^a-zA-Z0-9]/g, "") +
                                    ")' style='cursor:pointer; width:35px;'></center><input type='text' name='midI" + lid +
                                    "' value='" + lid + "@" + ltype + "@" + ldate + "@" + lnom + "@" + reason +
                                    "' style='width:100px' hidden='hidden'></td></tr></tbody>";
