    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getPositionAndGread(id,emptyid,maritalid) {
                $.ajax({
                    type: 'POST',
                    url: '../Controller/emp_profile.php?request=getPOSIandGradefromID&id=' + id + '&emptyid=' + emptyid + '&maritalid='+ maritalid,
                    success: function(data) {
                        var arr = data.split("#");
                        $("#grade").val(arr[0]);
                        $("#dept").val(arr[1]);
                                            ...
                                            <div>
                                                ...
                                                <div class="image-upload">
                                                 ...
                                                 <?php
                                                        ...
                                                        {
                                                           ?> <script>sweetalert("warning","Warning", "Please Add Image!");</script><?php
                                                        }
                                                        else if ( isset($_GET['msg']) && $_GET['msg'] == 2 )
                                                        {
                                                            ?> <script>sweetalert("success","Success", "Image Upload Successfully!");</script><?php
                                                        }
                                                        else if ( isset($_GET['msg']) && $_GET['msg'] == 3 )
                                                        {
                                                           ?> <script>sweetalert("error","Error", "Image Upload Unsuccessfully!");</script><?php
                                                        }
                                                        else if ( isset($_GET['msg']) && $_GET['msg'] == 4 )
                                                        {
                                                            ?> <script>sweetalert("warning","Warning", "Files Have Unknown File Formats!");</script><?php
                                                        }    
                                                    ?>
                                        ...
                                        <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                            <div class="card-body">
                                                <div class="profiletimeline mt-0">
                                                    ...
                                                    <button class="btn btn-success" type="submit" id="updatedetails" name="updatedetails" onclick="UpdateWantedDetails()">Update Profile</button>
