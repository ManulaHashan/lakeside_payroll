        ...
        <script type="text/javascript">
            ...
            function AutoGenerateFPW() {
                  ...
                  else
                  {
                     ...
                     var url = "../Controller/login.php?request=sendetpnocode&tpno=" + $('#tpno').val() + "&fwdcode=" + $('#tempcode').val();
            ...
            function ResetPW() {
                ...
                else
                {
                    if (pword1 == pword2) 
                    {
                        var url = "../Controller/login.php?request=resetpw&pass1=" + $('#pw1').val() + "&lid=" + $('#confirmuid').val();
