...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Notifications | Employee Profile</title>
        ...
        <script type="text/javascript">
           ...
           // 👇️ Search Employee Image URL By User ID
            function searchByID() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../Controller/emp_notification.php?request=getEmpsbyID',
           ...
           function loadTable() {
                ...
                var url = "../Controller/emp_notification.php?request=getleave&frmdate=" + $('#fdate').val() + "&tod=" + $('#tdate').val();
            ...
            function getrowid(id){
                ...
                var url = "../Controller/emp_notification.php?request=viewnotification&notid=" + id;
            ...
            function noticount(){
                ...
                var url = "../Controller/emp_notification.php?request=getnotificationcount";
            ...
            function loadNotifiation() {
                ...
                var url = "../Controller/emp_notification.php?request=getnotification";
            ...
            // 👇️ Change Notification Status
            function ChangeStatus(id) {

                var url = "../Controller/emp_notification.php?request=changestat&nid=" + id;
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Notifications Log</h5>
                                            <span>You can view your daily notifications from this page</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                        <h3>Daily Notification Table</h3>
                                    </div>
                                    <div class="card-body">
