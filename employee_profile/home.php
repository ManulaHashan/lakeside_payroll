                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (arr[0] == "B") 
                        {
                            ...
                            $("#box_1_leave").html(arr[1]+ "<sub style='font-size:10px;'>Taken</sub> / " +arr[2]+"<sub style='font-size:10px;'>Available</sub>");
                            $("#box_2_leave").html(arr[3]+ "<sub style='font-size:10px;'>Taken</sub> / " +arr[4]+"<sub style='font-size:10px;'>Available</sub>");
                            $("#box_medi_leave").html(arr[5]+ "<sub style='font-size:10px;'>Taken</sub> / " +arr[6]+"<sub style='font-size:10px;'>Available</sub>");
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                $("#box_1_leave").html(arr[1]+ "<sub style='font-size:10px;'>Taken</sub> / " +arr[2]+"<sub style='font-size:10px;'>Available</sub>");
                                $("#box_2_leave").html(arr[8]+ "<sub style='font-size:10px;'>Taken</sub> / " +arr[9]+"<sub style='font-size:10px;'>Available</sub>");
                                $("#box_3_leave").html(arr[12]);
                                $("#box_4_leave").html(arr[16]);
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header"><h3>Attendance Calender</h3></div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    <div class="card-header"><h3>Monthly Attendance Chart</h3></div>
                                    <div class="card-body">
