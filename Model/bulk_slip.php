...
<body id="Bulk_Data">
    ...
    if (isset($_GET["Month"])) {
        ...
        // $queryAll = "select id from salarycomplete where month = '".$_GET["Month"]."' and year = '".$_GET["Year"]."'";

        $queryAll = "select a.id from salarycomplete a, user b where a.uid=b.uid and a.month = '".$_GET["Month"]."' and a.year = '".$_GET["Year"]."' and b.isactive = '1'";
                 ...
                 <div class="grid-item">  
                    ...
                    <center> <?php
                        ...
                        if ($result = mysqli_fetch_assoc($res)) {
                            ...
                            $Basic_sal_for_epf = $result["basic"]+$result["br1"]+$result["br2"]-$result["nopay"];
